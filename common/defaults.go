...
const (
	...
	ArgoCDDefaultExportJobImage = "docker-opc-group-cicd-nexus.rp-ocn.apps.ocn.infra.ftgroup/gaas/argocd-operator-util" // ADEN "quay.io/argoprojlabs/argocd-operator-util"
